    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    employees = [
                        __assign({ fullName: "John Doe", birthDate: new Date("1980-01-01"), gender: "Male" }, {}),
                        __assign({ fullName: "Jane Smith", birthDate: new Date("1990-05-15"), gender: "Female" }, {}),
                        // Добавьте других сотрудников по аналогии
                    ];
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, EmployeeModel.insertMany(employees)];
                case 2:
                    _a.sent();
                ...
                case 3:
                    error_2 = _a.sent();
                    console.error("Failed to create employee table:", error_2);
                    return [3 /*break*/, 4];
