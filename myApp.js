...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var fullName, birthDate, gender, employee, age, randomEmployees, fLastNameEmployees, employees, batchSize, i, batch, startTime, employees, _i, employees_3, employee, error_6, endTime;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 15:
                    error_6 = _a.sent();
                    console.error("Failed to print employees:", error_6);
                    return [3 /*break*/, 16];
                case 16:
                    endTime = Date.now();
